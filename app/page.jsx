    ...
    <section className="w-full flex-center flex-col">
      ...
      <div className="flex gap-3 flex-wrap mb-10 mt-10">
        {lesson.map((el) => (
          <div
            key={el.id}
            className="flex bg-white shadow-lg rounded-lg mx-1 md:mx-auto my-1 max-w-md md:max-w-2xl "
          >
              ...
              <div className="">
                <div className="flex items-center justify-between">
                  ...
                  <small className="text-sm text-gray-700">
                    {" "}
                    Dodana {formatISO9075(new Date(el.createdAt))}
                  </small>
                </div>
                <p className="text-gray-700">{el.category.name} </p>
                <p className="mt-3 text-gray-700 text-sm">{el.content}</p>
